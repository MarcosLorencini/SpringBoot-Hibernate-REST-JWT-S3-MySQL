...
public class ClienteResource {
	...
	@PreAuthorize("hasAnyRole('ADMIN')") //somente o admininstrador pode deleter o cliente
	...
	//enviar a foto do perfil do cliente
	@RequestMapping(value="/picture", method=RequestMethod.POST)
	public ResponseEntity<Void> uploadProfilePicture(@RequestParam(name="file") MultipartFile file){
		URI uri = service.uploadProfilePicture(file);
		return ResponseEntity.created(uri).build();//retorna para a URI da imagem para o cabeçalho a req
	}
